...
import{SafeAreaView,StyleSheet,Text,View,ScrollView, TextInput, TouchableOpacity, FlatList, Dimensions,Image, Animated,AnimatedView}from 'react-native';
    ...
    const Card=({hotel,index})=>{
        ...
        <Animated.View style={{...style.card,transform:[{scale}]}}>
            ...
            <View style={style.priceTag}>
                <Text style={{color:'white',fontSize:20,fontWeight:'bold'}}>€{hotel.price}</Text>
            </View>
    ...
    return(
        ...
        <View style={style.header}>
            <View style={{paddingBottom:10}}>
                <Text style={{fontSize:25,fontWeight:'bold'}}>Find Your Hotel</Text>
            <View style={{flexDirection:'row'}}>
                <Text style={{fontSize:25,fontWeight:'bold'}}>in {'\n'}</Text>
                <Text style={{fontSize:25,fontWeight:'bold', color:'green'}}>Paris</Text>
            </View>
            </View>
